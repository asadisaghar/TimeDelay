# python experiments/regression.py est_dt_mean,est_dt_median,est_dt_std 2 dt \
...
# python experiments/predict.py est_dt_mean,est_dt_median,est_dt_std 2 dt \
...
python experiments/predict.py est_dt_mean,est_dt_median,est_dt_std 2 dt \
  TimeDelayData/timeshift_correlate_normalized_detrend.measures.pairsums.npz \
  model.pkl \
  TimeDelayData/timeshift_correlate_normalized_detrend.measures.pairsums.regression-ests.npz
